...
func (p *FooReply) GetValue() string {
  return p.Value
}

func (p *FooReply) GetErr() string {
  return p.Err
}
func (p *FooReply) Read(ctx context.Context, iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(ctx); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *FooReply)  ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
  p.Value = v
...
func (p *FooReply)  ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 2: ", err)
} else {
  p.Err = v
...
func (p *FooReply) Write(ctx context.Context, oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin(ctx, "FooReply"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(ctx, oprot); err != nil { return err }
    if err := p.writeField2(ctx, oprot); err != nil { return err }
...
func (p *FooReply) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin(ctx, "value", thrift.STRING, 1); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:value: ", p), err) }
  if err := oprot.WriteString(ctx, string(p.Value)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.value (1) field write error: ", p), err) }
...
func (p *FooReply) writeField2(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin(ctx, "err", thrift.STRING, 2); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:err: ", p), err) }
  if err := oprot.WriteString(ctx, string(p.Err)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.err (2) field write error: ", p), err) }
...
func (p *FooReply) Equals(other *FooReply) bool {
  if p == other {
    return true
  } else if p == nil || other == nil {
    return false
...
type AddService interface {
  // Parameters:
  //  - S
  Foo(ctx context.Context, s string) (r *FooReply, err error)
  // Parameters:
  //  - A
  //  - B
...
// Parameters:
//  - S
func (p *AddServiceClient) Foo(ctx context.Context, s string) (r *FooReply, err error) {
  var _args0 AddServiceFooArgs
  _args0.S = s
  var _result1 AddServiceFooResult
  var meta thrift.ResponseMeta
  meta, err = p.Client_().Call(ctx, "Foo", &_args0, &_result1)
...
func (p *AddServiceClient) Sum(ctx context.Context, a int64, b int64) (r *SumReply, err error) {
  var _args2 AddServiceSumArgs
  _args2.A = a
  _args2.B = b
  var _result3 AddServiceSumResult
  var meta thrift.ResponseMeta
  meta, err = p.Client_().Call(ctx, "Sum", &_args2, &_result3)
  p.SetLastResponseMeta_(meta)
  if err != nil {
    return
  }
...
func (p *AddServiceClient) Concat(ctx context.Context, a string, b string) (r *ConcatReply, err error) {
  ...
  var meta thrift.ResponseMeta
  meta, err = p.Client_().Call(ctx, "Concat", &_args4, &_result5)
  p.SetLastResponseMeta_(meta)
  if err != nil {
    return
  }
...
func NewAddServiceProcessor(handler AddService) *AddServiceProcessor {
  ...
  self6.processorMap["Foo"] = &addServiceProcessorFoo{handler:handler}
...
type addServiceProcessorFoo struct {
  handler AddService
}

func (p *addServiceProcessorFoo) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := AddServiceFooArgs{}
  var err2 error
  ...
  result := AddServiceFooResult{}
  var retval *FooReply
  if retval, err2 = p.handler.Foo(ctx, args.S); err2 != nil {
    tickerCancel()
...
// Attributes:
//  - S
type AddServiceFooArgs struct {
  S string `thrift:"s,1" db:"s" json:"s"`
}

func NewAddServiceFooArgs() *AddServiceFooArgs {
  return &AddServiceFooArgs{}
}


func (p *AddServiceFooArgs) GetS() string {
  return p.S
}
func (p *AddServiceFooArgs) Read(ctx context.Context, iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(ctx); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *AddServiceFooArgs)  ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
  p.S = v
...
func (p *AddServiceFooArgs) Write(ctx context.Context, oprot thrift.TProtocol) error {
...
func (p *AddServiceFooArgs) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
...
func (p *AddServiceFooArgs) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("AddServiceFooArgs(%+v)", *p)
}

// Attributes:
//  - Success
type AddServiceFooResult struct {
  Success *FooReply `thrift:"success,0" db:"success" json:"success,omitempty"`
}

func NewAddServiceFooResult() *AddServiceFooResult {
  return &AddServiceFooResult{}
}

var AddServiceFooResult_Success_DEFAULT *FooReply
func (p *AddServiceFooResult) GetSuccess() *FooReply {
  if !p.IsSetSuccess() {
    return AddServiceFooResult_Success_DEFAULT
  }
return p.Success
}
func (p *AddServiceFooResult) IsSetSuccess() bool {
  return p.Success != nil
}

func (p *AddServiceFooResult) Read(ctx context.Context, iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(ctx); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *AddServiceFooResult)  ReadField0(ctx context.Context, iprot thrift.TProtocol) error {
  p.Success = &FooReply{}
...
func (p *AddServiceFooResult) Write(ctx context.Context, oprot thrift.TProtocol) error {
...
func (p *AddServiceFooResult) writeField0(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetSuccess() {
...
func (p *AddServiceFooResult) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("AddServiceFooResult(%+v)", *p)
}
